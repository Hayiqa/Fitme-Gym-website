...
<?php  // creating a database connection 
   ...
   if($_POST)
   {
		   ...
		   $BMI=($weight/pow($height,2));
		     $sql_select="insert into logs(Username,weight,height,BMI,Day,calory_intake)
                           values ('$user','$weight','$height','$BMI','$day','$calory')";
...
<body>
  ...
  <h1> Enter your Logs </h1>
   ...
   <p>Weight </p>
    ...
    <p> Height </p>
	<input type = "number" name="height" placeholder="enter height in inches" required>
	<p>Day</p>
	<input type="text" name="day" placeholder="eg. 25-feb-04" required>
	<p>Calory Intake</p>
	<input type="number" name="calory" placeholder="enter calory intake" required>
